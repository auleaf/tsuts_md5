...
// 测试
console.log("MD5 of 'hello world':", md5("hello world")); // 5eb63bbbe01eeed093cb22bb8f5acdc3

const hash1 = md5('hello world')
console.log('MD5 of "hello world"==', hash1) // '5eb63bbbe01eeed093cb22bb8f5acdc3'
console.log("5eb63bbbe01eeed093cb22bb8f5acdc3")
// let mydata:Array<string> = [];
// let arr = new Array("auleaf","Runoob","Taobao");
